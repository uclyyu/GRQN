...
class GeRN(nn.Module):
    def __init__(self, nr=128, nq=32, nh=32, nv=4):
    ...
    def _forward_mc_loop(self, ndraw: int, cnd_repr: Tensor, qry_jrep: Tensor, qry_drep: Tensor, qry_v: Tensor,
        ...
        for ast in range(ndraw):
            ...
            inp_id = torch.cat([cnd_repr_d, qry_drep, hg_dlos, qry_v], dim=1)
            ...
            inp_gd = torch.cat([cnd_repr_d, po_z_dlos, qry_v], dim=1)
